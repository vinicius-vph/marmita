...
export default async function Footer({ showAdminLink = false }: Props) {
  ...
  return (
    <footer className="bg-teal-900 text-teal-200 py-8 px-4 text-center text-sm">
      <div className="max-w-sm mx-auto flex flex-col items-center gap-5">
        ...
        {showAdminLink && (
          <Link
            href="/admin/login"
            className="inline-flex items-center gap-1.5 text-teal-500 hover:text-white text-xs transition-colors py-1"
          >
        ...
        {process.env.NEXT_PUBLIC_APP_VERSION && (
          <p className="text-teal-600 text-xs">v{process.env.NEXT_PUBLIC_APP_VERSION}</p>
        )}
